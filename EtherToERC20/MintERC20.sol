...
contract EtherToToken is ERC20Interface {
    ...
    constructor() {
        _name = "ERC20-TOKEN";
        _symbol = "ERCTK";
        _totalSupply = 100000 * 10 ** 18; //100000 tokens
    }
    ...
    // This function mints ERC20 token equal to given eth amount
    function transferEtherToToken() external payable {
        uint256 _amount = msg.value; // Ether value
        require(_amount > 0, "Transfer Failed: Not enough amount.");
